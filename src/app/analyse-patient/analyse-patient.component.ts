...
@Component({
  selector: 'app-analyse-patient',
  templateUrl: './analyse-patient.component.html',
  styleUrls: ['./analyse-patient.component.css']
})
export class AnalysePatientComponent implements OnInit {
  id: string;
